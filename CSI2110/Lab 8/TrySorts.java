...
public class TrySorts extends Applet implements MouseListener, WindowListener {
  IvjEventHandler ivjEventHandler = new IvjEventHandler();
	...
	private Checkbox ivjQuickSortRandomBox = null;
  ...
  private void connPtoP9SetTarget() {
	    /* Set the target from the source */
	    try {
	      getQuickSortRandomBox().setCheckboxGroup(getSortTypeGroup());
	    } catch (java.lang.Throwable ivjExc) {
	      handleException(ivjExc);
	    }
  }
  ...
  public String doQuickSortRandom(Long[] seq, int size) {
	    java.util.Date timeIn = new java.util.Date( );
	    new QuickSortRandomPivot<Long>( seq );
	    // Sorters.quickSort( seq, 0, size - 1 );
	    java.util.Date timeOut = new java.util.Date( );
	    long timeTaken = timeOut.getTime( ) - timeIn.getTime( );
	    return Long.toString(timeTaken);
  ...
  public void doStartButton( String arraySizeText, 
    ...
    if (checkFields(arraySizeText, maxElementText, 
                    sortOption ))
      {
        ...
        else if (sortOption == getQuickSortRandomBox()) {
            getOutputArea().append("Starting quick sort with random pivot...\n");
            timeTaken = doQuickSortRandom(testSequence, arraySize);
          }
  ...
  //abc
  private java.awt.Checkbox getQuickSortRandomBox() {
	    if (ivjQuickSortRandomBox == null) {
	      try {
	        ivjQuickSortRandomBox = new java.awt.Checkbox();
	        ivjQuickSortRandomBox.setName("QuickSortRandomBox");
	        ivjQuickSortRandomBox.setBounds(314, 145, 300, 23);
	        ivjQuickSortRandomBox.setLabel("Quick sort random pivot");
	      } catch (java.lang.Throwable ivjExc) {
	        handleException(ivjExc);
	      }
	    }
	    return ivjQuickSortRandomBox;
	  }
  ...
  public void init() {
    try {
      ...
      add(getQuickSortRandomBox(), getQuickSortRandomBox().getName());
