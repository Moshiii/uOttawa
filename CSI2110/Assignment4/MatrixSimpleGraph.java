...
public class MatrixSimpleGraph {
   ...
   */
  public MatrixSimpleGraph( String fileName ) throws InvalidPositionException, IOException {
  ...
  public static void main( String[] argv ) {
    ...
    try {
      MatrixSimpleGraph sGraph = new MatrixSimpleGraph( argv[0] );
      sGraph.print();
